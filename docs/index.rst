...
Valid data types supported are "FLOAT", "INTEGER", "STRING", "FLOAT_ARRAY", "DP_DICT", "DP_LIST", "IMAGE", "DATABUFFER", "2D_FLOAT_ARRAY", "NUMBER", "NON-NUMERIC", "FLOATING", "BUFFER". "FLOATING" maps to "FLOAT", "BUFFER" maps to "DATABUFFER". "NUMBER" type which removes both integer and floating point values and the "NON-NUMERIC" that removes everything except integer and floating point values, USER_ARRAY will remove both FLOAT_ARRAY and 2D_FLOAT_ARRAY datapoints. Nested will remove DP_DICT, ARRAY will remove FLOAT_ARRAY, 2D_ARRAY will remove 2D_FLOAT_ARRAY datapoints. Datapoint types are case insensitive.
